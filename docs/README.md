...
| [rpc.md](./rpc.md)                           | The fiber RPC client's transport: the host's fetch, how a call is written and its answer read, the three errors by what the caller can conclude, what the client does not do, and where amounts change form.                                    |
