import { MAX_CHANNEL_INDEX, MAX_COMMITMENT_NUMBER, NONCE_CONTEXTS } from "../../derivation/index.js";
import { CHANNEL_POLICY_RECORD_VERSION, MAX_AMOUNT_SHANNONS, MESSAGE_DIGEST_LENGTH } from "../policy.constants.js";
